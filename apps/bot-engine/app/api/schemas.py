...
# The recursive Condition / Rule shape validated here mirrors the DSL parsed by
# xbt_core.strategies.rule_engine. Pydantic checks the structure; the engine
# rebuilds its own dataclasses from model_dump() (see factory.build_strategy).
